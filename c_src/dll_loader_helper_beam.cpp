...
{
#endif
	static ERL_NIF_TERM dll_loader_helper_beam_nif_addDLLDirectory(ErlNifEnv* env, int argc, const ERL_NIF_TERM argv[]) {
	...
	static ErlNifFunc nif_functions[] = {
		{"add_dll_directory", 1, dll_loader_helper_beam_nif_addDLLDirectory, 0},
	};
	
	ERL_NIF_INIT(dll_loader_helper_beam_nif, nif_functions, on_load, on_reload, on_upgrade, NULL);
#ifdef __cplusplus
}
#endif
